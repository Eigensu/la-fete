                ...
                >
                    ...
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                        {!isLogin && (
                            <div className="space-y-1">
                                <label className="block font-poppins text-[9px] uppercase tracking-[0.2em] text-gray-400 pl-1">Full Name</label>
                        ...
                        <button className="w-full py-3 bg-gradient-to-r from-[#86162f] via-[#a82043] to-[#f8aeb2] text-white font-poppins text-[11px] uppercase tracking-widest hover:opacity-90 transition-opacity rounded-sm shadow-lg mt-2">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-100 rounded-sm hover:bg-gray-50 transition-colors">
