...
export default function AdminOrderDetailsPage() {
  ...
  useEffect(() => {
    const fetchOrder = async () => {
      try {
        ...
        toast.error('Failed to load admin order details');
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return <div className="py-8 px-4 animate-pulse">
  ...
  return (
    <div className="py-8 px-4">
      <Link href="/admin/orders" className="flex items-center gap-2 text-gray-600 hover:text-black mb-6">
