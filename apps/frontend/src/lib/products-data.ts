...
export const ALL_PRODUCTS: Product[] = [
  // ── WHOLE WHEAT ─────────────────────────────────────────────────────────
  {
    ...
    availableWeights: [{ weight: '500g', price: 1000 }, { weight: '1kg', price: 1800 }], sweetenerOptions: SW_WW,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1699 }, { weight: '1kg', price: 2500 }], sweetenerOptions: SW_WW,
    allergens: 'Made in a facility that handles dairy, nuts, and eggs.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
    id: 'ww-2b', slug: 'sugar-free-dark-chocolate-cake',
    name: 'Sugar-Free Dark Chocolate Cake', flavour: 'Chocolate', dietary: ['Whole Wheat', 'Sugar Free'], format: 'Whole Cake',
    collections: ['whole-wheat'],
    shortDescription: 'A deeply rich dark chocolate cake built on a whole wheat base, sweetened naturally with no refined sugar.',
    availableWeights: [{ weight: '500g', price: 1999 }, { weight: '1kg', price: 2800 }], sweetenerOptions: SW_WW,
    allergens: 'Made in a facility that handles dairy, nuts, and eggs.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1199 }, { weight: '1kg', price: 2000 }], sweetenerOptions: SW_WW,
    allergens: 'Made in a facility that handles dairy, nuts, and eggs.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1399 }, { weight: '1kg', price: 2400 }], sweetenerOptions: SW_WW,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1699 }, { weight: '1kg', price: 3000 }], sweetenerOptions: SW_WW,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1799 }, { weight: '1kg', price: 3200 }], sweetenerOptions: SW_WW,
    allergens: 'Contains pistachios and nuts. Made in a facility that handles dairy and eggs.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1499 }, { weight: '1kg', price: 2600 }], sweetenerOptions: SW_WW,
    allergens: 'Made in a facility that handles dairy, nuts, and eggs.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
  ...
  // ── VEGAN & SUGAR FREE ──────────────────────────────────────────────────
  {
    ...
    availableWeights: [{ weight: '500g', price: 1699 }, { weight: '1kg', price: 3000 }], sweetenerOptions: SW_VEGAN,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1899 }, { weight: '1kg', price: 3200 }], sweetenerOptions: SW_VEGAN,
    allergens: 'May contain traces of nuts. Made in a shared facility.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 2199 }, { weight: '1kg', price: 3800 }], sweetenerOptions: SW_VEGAN,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 2299 }, { weight: '1kg', price: 4000 }], sweetenerOptions: SW_VEGAN,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 2399 }, { weight: '1kg', price: 4200 }], sweetenerOptions: SW_VEGAN,
    allergens: 'May contain traces of nuts. Made in a shared facility.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
  ...
  // ── GF & SUGAR FREE ─────────────────────────────────────────────────────
  {
    ...
    availableWeights: [{ weight: '500g', price: 1699 }, { weight: '1kg', price: 2800 }], sweetenerOptions: SW_GF,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1899 }, { weight: '1kg', price: 3200 }], sweetenerOptions: SW_GF,
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 1799 }, { weight: '1kg', price: 3000 }], sweetenerOptions: SW_GF,
  ...
  // ── BOOZY WHOLE WHEAT ────────────────────────────────────────────────────
  {
    ...
    collections: ['boozy-whole-wheat'],
    shortDescription: 'A whole wheat cake soaked in Baileys and espresso — indulgent, spirited, and impossible to resist.',
    availableWeights: [{ weight: '500g', price: 1999 }, { weight: '1kg', price: 3000 }], sweetenerOptions: SW_LIQUOR,
  ...
  },
  {
    ...
    collections: ['boozy-whole-wheat', 'tub-cakes'],
  ...
  },
  {
    ...
    availableWeights: [{ weight: '500g', price: 2299 }, { weight: '1kg', price: 3200 }], sweetenerOptions: SW_LIQUOR,
    allergens: 'Contains alcohol. Made in a facility that handles dairy and nuts. Not suitable for minors.',
    storage: 'Best consumed within 3 days. Refrigerate after delivery.',
  },
